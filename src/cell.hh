...
class voronoicell_base {
	public:
		 ...
		 * \param[in] fp the file handle to write to. */
		virtual void output_neighbors(FILE *fp=stdout) {(void)fp;}
		...
		virtual void print_edges_neighbors(int i) {(void)i;}
...
class voronoicell : public voronoicell_base {
	public:
		...
		void init_l_shape();
	private:
		inline void n_allocate(int i,int m) {(void)i;(void)m;}
		inline void n_add_memory_vertices(int i) {(void)i;};
		inline void n_add_memory_vorder(int i) {(void)i;};
		inline void n_set_pointer(int p,int n) {(void)p;(void)n;}
		inline void n_copy(int a,int b,int c,int d) {(void)a;(void)b;(void)c;(void)d;};
		inline void n_set(int a,int b,int c) {(void)a;(void)b;(void)c;};
		inline void n_set_aux1(int k) {(void)k;};
		inline void n_copy_aux1(int a,int b) {(void)a;(void)b;};
		inline void n_copy_aux1_shift(int a,int b) {(void)a;(void)b;};
		inline void n_set_aux2_copy(int a,int b) {(void)a;(void)b;};
		inline void n_copy_pointer(int a,int b) {(void)a;(void)b;};
		inline void n_set_to_aux1(int j) {(void)j;};
		inline void n_set_to_aux2(int j) {(void)j;};
		inline void n_allocate_aux1(int i) {(void)i;};
		inline void n_switch_to_aux1(int i) {(void)i;};
		inline void n_copy_to_aux1(int i,int m) {(void)i;(void)m;};
		inline void n_set_to_aux1_offset(int k,int m) {(void)k;(void)m;};
